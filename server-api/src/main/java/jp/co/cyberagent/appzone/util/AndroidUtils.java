/*
 * Code posted on StackOverflow by Ribo:
 * http://stackoverflow.com/a/4761689/496992
 */

package jp.co.cyberagent.appzone.util;
...
public class AndroidUtils {
    ...
    public static String getStringFromResource(final File tempApk, final int resId) throws AndrolibException {
    ...
    public static Set<String> getFileSetFromResource(final File tempApk, final int resId) throws AndrolibException {
        AndrolibResources res = new AndrolibResources();
        ExtFile file = new ExtFile(tempApk);
        ResTable table = res.getResTable(file);
        ResPackage defaultPackage = table.listMainPackages().iterator().next();
        ...
        for (ResResource resource : table.getResSpec(resId).listResources()) {
            files.add("res/" + resource.getFilePath());
        }
        return files;
    }
